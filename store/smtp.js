...
let Email = {
	send: function(e, o, t, n, a, s, r, c) {
		...
		void 0 == a.token
			? (i += '&Host=' + a, i += '&Username=' + s, i += '&Password=' + r, i += '&Action=Send')
			: (i += '&SecureToken=' + a.token, i += '&Action=SendFromStored', c = a.callback),
		i += '&cachebuster=' + d,
	...
	sendWithAttachment: function(e, o, t, n, a, s, r, c, d) {
		...
		void 0 == a.token
			? (m += '&Host=' + a, m += '&Username=' + s, m += '&Password=' + r, m += '&Action=Send')
